...
const LogoSvg = (
  <svg
    className="w-10 h-10 m-1 flex-shrink-0"
...
const Logo: React.FC = () => {
  return (
    <div id="logo" className="h-16 box-border overflow-hidden">
      <Link to="/" className="flex items-center flex-nowrap  my-3 mx-4">
        {LogoSvg}
        <strong className="text-white text-lg flex-shrink truncate">Antd Admin</strong>
      </Link>
    </div>
  )
}
